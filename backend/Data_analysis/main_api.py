...
class Config:
    ...
    ANALYSIS_API_KEY = os.getenv('ANALYSIS_API_KEY', 'sk-0fb27bf3a9a448fa9a6f02bd70e37cd8')
    ...
    # 可视化配置
    VISUALIZER_API_KEY = os.getenv('VISUALIZER_API_KEY', 'sk-Y4o8DF6Iq2l8OcieaS1gXfgIzFkfymV4oF01ofphYB5FxnFT')
